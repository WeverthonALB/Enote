...
from tkinter import ttk, messagebox, simpledialog, filedialog  # Adicionado filedialog
...
class GerenciadorNotasApp:
    ...
    def adicionar_notas_gui(self):
        ...
        def salvar():
            ...
            self.conexao.commit()
            self.notas.setdefault(aluno_id, []).append({"disciplina": disc, "componentes": comps})
